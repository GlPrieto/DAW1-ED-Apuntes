...
- Identificar las herramientas para la elaboración de diagramas de clases.EasiUML
...
- Es un lenguaje visual de propósito general para representar **modelos**. Gráfico
...
- **diagramas de comportamiento** (aspecto dinámico) Siguiente tema
